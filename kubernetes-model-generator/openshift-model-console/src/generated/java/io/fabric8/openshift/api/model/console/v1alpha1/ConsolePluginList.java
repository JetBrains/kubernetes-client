...
public class ConsolePluginList implements KubernetesResource, KubernetesResourceList<io.fabric8.openshift.api.model.console.v1alpha1.ConsolePlugin>
{
    ...
    @JsonProperty("items")
    private List<io.fabric8.openshift.api.model.console.v1alpha1.ConsolePlugin> items = new ArrayList<io.fabric8.openshift.api.model.console.v1alpha1.ConsolePlugin>();
    /**
     * 
     * (Required)
     * 
