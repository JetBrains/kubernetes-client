...
public class PriorityLevelConfiguration implements HasMetadata
{
     ...
     * @param status
     */
    public PriorityLevelConfiguration(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, PriorityLevelConfigurationSpec spec, PriorityLevelConfigurationStatus status) {
        super();
