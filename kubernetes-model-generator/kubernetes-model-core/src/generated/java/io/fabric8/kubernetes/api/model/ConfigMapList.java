...
public class ConfigMapList implements KubernetesResource, KubernetesResourceList<io.fabric8.kubernetes.api.model.ConfigMap>
{
     ...
     * @param items
     */
    public ConfigMapList(String apiVersion, List<io.fabric8.kubernetes.api.model.ConfigMap> items, String kind, ListMeta metadata) {
        super();
    ...
    @JsonProperty("items")
    public void setItems(List<io.fabric8.kubernetes.api.model.ConfigMap> items) {
        this.items = items;
    }
