...
public class NamespaceList implements KubernetesResource, KubernetesResourceList<io.fabric8.kubernetes.api.model.Namespace>
{
     ...
     * @param items
     */
    public NamespaceList(String apiVersion, List<io.fabric8.kubernetes.api.model.Namespace> items, String kind, ListMeta metadata) {
        super();
    ...
    @JsonProperty("items")
    public void setItems(List<io.fabric8.kubernetes.api.model.Namespace> items) {
        this.items = items;
    }
