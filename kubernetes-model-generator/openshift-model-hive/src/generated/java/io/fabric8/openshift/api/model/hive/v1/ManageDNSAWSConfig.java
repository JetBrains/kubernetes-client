...
public class ManageDNSAWSConfig implements KubernetesResource
{
     ...
     * @param region
     */
    public ManageDNSAWSConfig(io.fabric8.kubernetes.api.model.LocalObjectReference credentialsSecretRef, String region) {
        super();
