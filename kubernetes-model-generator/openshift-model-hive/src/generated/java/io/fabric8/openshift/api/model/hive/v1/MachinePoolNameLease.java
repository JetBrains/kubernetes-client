...
public class MachinePoolNameLease implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public MachinePoolNameLease(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, MachinePoolNameLeaseSpec spec, MachinePoolNameLeaseStatus status) {
        super();
