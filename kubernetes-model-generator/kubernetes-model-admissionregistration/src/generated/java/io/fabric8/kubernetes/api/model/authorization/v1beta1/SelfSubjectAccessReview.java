...
public class SelfSubjectAccessReview implements HasMetadata
{
     ...
     * @param status
     */
    public SelfSubjectAccessReview(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, SelfSubjectAccessReviewSpec spec, SubjectAccessReviewStatus status) {
        super();
