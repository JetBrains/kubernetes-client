...
public class PodSecurityPolicyReviewSpec implements KubernetesResource
{
     ...
     */
    public PodSecurityPolicyReviewSpec(List<String> serviceAccountNames, io.fabric8.kubernetes.api.model.PodTemplateSpec template) {
        super();
