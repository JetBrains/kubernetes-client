...
public class ImageStreamImport implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public ImageStreamImport(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, ImageStreamImportSpec spec, ImageStreamImportStatus status) {
        super();
