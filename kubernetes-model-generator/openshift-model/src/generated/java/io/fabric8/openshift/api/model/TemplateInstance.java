...
public class TemplateInstance implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public TemplateInstance(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, TemplateInstanceSpec spec, TemplateInstanceStatus status) {
        super();
