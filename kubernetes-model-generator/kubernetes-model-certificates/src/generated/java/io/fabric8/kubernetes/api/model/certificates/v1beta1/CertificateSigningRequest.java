...
public class CertificateSigningRequest implements HasMetadata
{
     ...
     * @param status
     */
    public CertificateSigningRequest(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, CertificateSigningRequestSpec spec, CertificateSigningRequestStatus status) {
        super();
