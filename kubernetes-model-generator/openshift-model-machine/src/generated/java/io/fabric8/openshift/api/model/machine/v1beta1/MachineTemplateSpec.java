...
public class MachineTemplateSpec implements KubernetesResource
{
     ...
     * @param spec
     */
    public MachineTemplateSpec(io.fabric8.openshift.api.model.machine.v1beta1.ObjectMeta metadata, MachineSpec spec) {
        super();
