...
public class KubeControllerManager implements HasMetadata
{
     ...
     * @param status
     */
    public KubeControllerManager(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, KubeControllerManagerSpec spec, KubeControllerManagerStatus status) {
        super();
