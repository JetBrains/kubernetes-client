...
public class OpenShiftAPIServer implements HasMetadata
{
     ...
     * @param status
     */
    public OpenShiftAPIServer(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, OpenShiftAPIServerSpec spec, OpenShiftAPIServerStatus status) {
        super();
