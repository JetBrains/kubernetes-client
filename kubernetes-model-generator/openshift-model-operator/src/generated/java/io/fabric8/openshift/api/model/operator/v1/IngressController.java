...
public class IngressController implements HasMetadata, Namespaced
{
     ...
     * @param status
     */
    public IngressController(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, IngressControllerSpec spec, IngressControllerStatus status) {
        super();
