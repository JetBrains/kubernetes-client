...
public class ClusterCSIDriverStatus implements KubernetesResource
{
     ...
     */
    public ClusterCSIDriverStatus(List<OperatorCondition> conditions, List<GenerationStatus> generations, Long observedGeneration, Integer readyReplicas, String version) {
        super();
