...
public class KubeSchedulerSpec implements KubernetesResource
{
     ...
     */
    public KubeSchedulerSpec(Integer failedRevisionLimit, String forceRedeploymentReason, String logLevel, String managementState, HasMetadata observedConfig, String operatorLogLevel, Integer succeededRevisionLimit, HasMetadata unsupportedConfigOverrides) {
        super();
