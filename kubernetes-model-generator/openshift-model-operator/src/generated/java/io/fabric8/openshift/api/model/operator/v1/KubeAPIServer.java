...
public class KubeAPIServer implements HasMetadata
{
     ...
     * @param status
     */
    public KubeAPIServer(String apiVersion, String kind, io.fabric8.kubernetes.api.model.ObjectMeta metadata, KubeAPIServerSpec spec, KubeAPIServerStatus status) {
        super();
